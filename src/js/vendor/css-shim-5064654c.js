...
function lex (e) {
  ...
  for (var r = t, n = 0, s = e.length; n < s; n++) {
    if (e[n] === OPEN_BRACE) {
      r.rules || (r.rules = [])
      var o = r
      var a = o.rules[o.rules.length - 1] || null
...
function parseCss (e, t) {
  ...
  if (((e.parsedCssText = e.cssText = r.trim()), e.parent)) {
    ...
    ;(e.atRule = s.indexOf(AT_START) === 0),
    e.atRule
      ? s.indexOf(MEDIA_START) === 0
...
function parseVar (e, t) {
  ...
  var s = e.substring(r.end, n - 1).split(',')
  var o = s[0]
  var a = s.slice(1)
...
function compileVar (e, t, r) {
  ...
  var s = n.propName
  var o = n.fallback != null ? compileTemplate(n.fallback) : void 0
  return (
...
function reScope (e, t) {
  var r = e.template.map(function (r) {
    return typeof r === 'string' ? replaceScope(r, e.scopeId, t) : r
  })
...
function loadDocumentLinks (e, t) {
  for (
    var r = [], n = e.querySelectorAll('link[rel="stylesheet"][href]:not([data-no-shim])'), s = 0;
    s < n.length;
    s++
  ) {
