const NAMESPACE = 'dev-docs-dmc-search'
const BUILD = /* dev-docs-dmc-search */ {
  allRenderFn: true,
...
const getScopeId = (cmp, mode) =>
  'sc-' + (BUILD.mode && mode && cmp.$flags$ & 32 /* CMP_FLAGS.hasMode */ ? cmp.$tagName$ + '-' + mode : cmp.$tagName$)
  ...
  if (BUILD.vdomText && newVNode.$text$ !== null) {
    ...
    elm = newVNode.$elm$ = BUILD.svg
      ? doc.createElementNS(
        ...
        BUILD.slotRelocation && newVNode.$flags$ & 2 /* VNODE_FLAGS.isSlotFallback */ ? 'slot-fb' : newVNode.$tag$
      )
      : doc.createElement(
        BUILD.slotRelocation && newVNode.$flags$ & 2 /* VNODE_FLAGS.isSlotFallback */ ? 'slot-fb' : newVNode.$tag$
      )
...
const forceUpdate = (ref) => {
  if (BUILD.updatable) {
    ...
    if (
      isConnected &&
      (hostRef.$flags$ & (2 /* HOST_FLAGS.hasRendered */ | 16)) /* HOST_FLAGS.isQueuedForUpdate */ ===
...
const setValue = (ref, propName, newVal, cmpMeta) => {
  ...
  if (
    (!BUILD.lazyLoad || !((flags & 8) /* HOST_FLAGS.isConstructingInstance */) || oldVal === undefined) &&
    didValueChange
  ) {
...
const initializeComponent = async (elm, hostRef, cmpMeta, hmrVersionId, Cstr) => {
  ...
  if (
    ...
    if (BUILD.lazyLoad || BUILD.hydrateClientSide) {
      ...
      customElements.whenDefined(cmpMeta.$tagName$).then((/* HOST_FLAGS.isWatchReady */) => (hostRef.$flags$ |= 128))
    }
  ...
  if (BUILD.scoped && cmpMeta.$flags$ & 2 /* CMP_FLAGS.scopedCssEncapsulation */) {
    ...
    Object.defineProperty(hostElementPrototype, 'textContent', {
      get () {
        ...
        if (
          ((_a = slotNode === null || slotNode === void 0 ? void 0 : slotNode.nextSibling) === null || _a === void 0
            ? void 0
...
const flush = () => {
  ...
  if (BUILD.asyncQueue) {
    const timeout =
      (plt.$flags$ & 6) /* PLATFORM_FLAGS.queueMask */ === 2 /* PLATFORM_FLAGS.appLoaded */
