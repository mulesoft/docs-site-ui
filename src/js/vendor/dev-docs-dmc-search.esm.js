...
patchBrowser().then((options) => {
  ...
  return bootstrapLazy(
    [
      ['results-manager', [[0, 'results-manager']]],
      ['sample-component', [[1, 'sample-component', { pagerState: [32], statusState: [32] }]]],
      ['sample-result-component', [[1, 'sample-result-component', { result: [32] }]]],
    ],
    options
  )
})
