import { r as registerInstance, f as forceUpdate, h, g as getElement } from './index-e533b54f.js'
import { i as initializeBindings } from './index-3d8edb2a.js'
...
var jp = ve(wp())
var Bp = ve(Mp())
var V = new Error('Failed to load reducers.')
...
var _q = (typeof Symbol !== 'undefined' && Symbol.iterator) || '@@iterator'
...
var Je = new Xx()
var Zx = Je.produce
var $q = Je.produceWithPatches.bind(Je)
var Hq = Je.setAutoFreeze.bind(Je)
var zq = Je.setUseProxies.bind(Je)
var Wq = Je.applyPatches.bind(Je)
var Yq = Je.createDraft.bind(Je)
var Kq = Je.finishDraft.bind(Je)
var wr = Zx
v(g, ve(Mo()))
var Yi = 'NOT_FOUND'
function eR (e) {
...
function Vf (e, t) {
  if (!e) throw pR ? new Error(Df) : new Error(Df + ': ' + (t || ''))
}
function fR (e, t, r, a) {
  return JSON.stringify(e, mR(t, a), r)
}
function mR (e, t) {
  var r = []
  var a = []
  return (
    t ||
      (t = function (n, o) {
        return r[0] === o ? '[Circular ~]' : '[Circular ~.' + a.slice(0, r.indexOf(o)).join('.') + ']'
      }),
    function (n, o) {
      if (r.length > 0) {
...
function Mf (e, t, r, a) {
  ...
  if (!e(r)) {
    ...
    for (var o in r) {
      var i = a ? a + '.' + o : o
      ;(t.length && t.indexOf(i) !== -1) || (n.children[o] = Mf(e, t, r[o], i))
    }
  }
  return n
}
function Qf (e, t, r, a, n, o) {
  t === void 0 && (t = []), n === void 0 && (n = !1), o === void 0 && (o = '')
  ...
  for (var c in u) {
    ...
    if (!(t.length && t.indexOf(l) !== -1)) {
      var d = Qf(e, t, r.children[c], a[c], s, l)
...
function hR (e) {
  ...
  var t = e.isImmutable
  var r = t === void 0 ? Nf : t
  var a = e.ignoredPaths
  var n = e.warnAfter
  var o = n === void 0 ? 32 : n
  var i = e.ignore
  a = a || i
  var s = gR.bind(null, r, a)
  return function (u) {
    var c = u.getState
    var l = c()
    var d = s(l)
    ...
    return function (p) {
      return function (f) {
        var h = Tf(o, 'ImmutableStateInvariantMiddleware')
...
function yR (e) {
  ...
  var r = t === void 0 ? Bl : t
  var a = e.getEntries
  var n = e.ignoredActions
  var o = n === void 0 ? [] : n
  var i = e.ignoredActionPaths
  var s = i === void 0 ? ['meta.arg', 'meta.baseQueryMeta'] : i
  var u = e.ignoredPaths
  var c = u === void 0 ? [] : u
  var l = e.warnAfter
  var d = l === void 0 ? 32 : l
  var m = e.ignoreState
  var p = m === void 0 ? !1 : m
  var f = e.ignoreActions
  var h = f === void 0 ? !1 : f
  return function (C) {
    return function (x) {
      return function (R) {
        var F = x(R)
        var P = Tf(d, 'SerializableStateInvariantMiddleware')
        return (
          !h &&
            !(o.length && o.indexOf(R.type) !== -1) &&
            P.measureTime(function () {
              ...
              if (U) {
                ...
                var z = U.value
                console.error(
                  'A non-serializable value was detected in an action, in the path: `' + X + '`. Value:',
                  z,
                  `
          ...
          p ||
            (P.measureTime(function () {
              ...
              if (X) {
                ...
                var I = X.value
                console.error(
                  'A non-serializable value was detected in the state, in the path: `' + z + '`. Value:',
                  I,
                  `
...
function Xi (e) {
  ...
  var t = e.thunk
  var r = t === void 0 ? !0 : t
  var a = e.immutableCheck
  var n = a === void 0 ? !0 : a
  var o = e.serializableCheck
  var i = o === void 0 ? !0 : o
  var s = new kf()
...
function _l (e) {
  ...
  var f = i
  if (typeof f === 'function' && ((f = f(t)), !Ul && !Array.isArray(f))) {
...
var wm = (e) =>
  `${e.protocol}//${e.hostname}${e.pathname.indexOf('/') === 0 ? e.pathname : `/${e.pathname}`}${e.search}`
var ti = { pageview: 'pageview', event: 'event' }
var Om = class {
  constructor ({ client: t, uuidGenerator: r = Ka }) {
    ;(this.actionData = {}),
    (this.client = t),
    (this.uuidGenerator = r),
    (this.pageViewId = r()),
    (this.nextPageViewId = this.pageViewId),
    (this.currentLocation = wm(window.location)),
  ...
  getDefaultContextInformation (t) {
    const r = { title: document.title, encoding: document.characterSet }
    const a = { screenResolution: `${screen.width}x${screen.height}`, screenColor: `${screen.colorDepth}-bit` }
    const n = { language: navigator.language, userAgent: navigator.userAgent }
    const o = { time: Date.now().toString(), eventId: this.uuidGenerator() }
    return Object.assign(Object.assign(Object.assign(Object.assign({}, o), a), n), r)
  }

  updateLocationForNextPageView (t, r) {
    const { pageViewId: a, referrer: n, location: o } = this.getNextValues(t, r)
    ;(this.lastReferrer = n),
    (this.pageViewId = a),
    (this.currentLocation = o),
    t === ti.pageview && ((this.nextPageViewId = this.uuidGenerator()), (this.hasSentFirstPageView = !0))
  }

  getNextValues (t, r) {
    return {
      pageViewId: t === ti.pageview ? this.nextPageViewId : this.pageViewId,
      referrer: t === ti.pageview && this.hasSentFirstPageView ? this.currentLocation : this.lastReferrer,
      location: t === ti.pageview ? this.getCurrentLocationFromPayload(r) : this.currentLocation,
    }
  }

  getCurrentLocationFromPayload (t) {
    if (t.page) {
      const r = (n) => n.replace(/^\/?(.*)$/, '/$1')
      return `${((n) => n.split('/').slice(0, 3).join('/'))(this.currentLocation)}${r(t.page)}`
    } else return wm(window.location)
  }
}
var os = Object.assign({}, ti)
var qm = Object.keys(os).map((e) => os[e])
var Tm = class extends Om {
  constructor ({ client: t, uuidGenerator: r = Ka }) {
  ...
  addHooksForSVCEvents () {
    this.client.registerBeforeSendEventHook((t, ...[r]) => (qm.indexOf(t) !== -1 ? this.addSVCDataToPayload(t, r) : r)),
    this.client.registerAfterSendEventHook(
      (t, ...[r]) => (qm.indexOf(t) !== -1 && this.updateLocationInformation(t, r), r)
    )
  }

  addHooksForPageView () {
    this.client.addEventTypeMapping(os.pageview, {
      newEventType: Ce.collect,
  ...
  addHooksForEvent () {
    this.client.addEventTypeMapping(os.event, {
      newEventType: Ce.collect,
  ...
  addSVCDataToPayload (t, r) {
    ...
    const n = Object.assign(
      Object.assign(
        Object.assign(Object.assign({}, this.getLocationInformation(t, r)), this.getDefaultContextInformation(t)),
        this.action ? { svcAction: this.action } : {}
      ),
      Object.keys((a = this.actionData) !== null && a !== void 0 ? a : {}).length > 0
        ? { svcActionData: this.actionData }
        : {}
    )
    const o = this.getTicketPayload()
    return this.clearData(), Object.assign(Object.assign(Object.assign({}, o), n), r)
  }

  getTicketPayload () {
    return uv(this.ticket)
  }
}
Tm.Id = 'svc'
var km
...
var nM = new Q({
  options: { required: !1 },
  values: {
    by: new Ot({ enum: Fa, required: !0 }),
    fields: new Y({ each: new Q({ values: { name: new w(), direction: new Ot({ enum: Hg }) } }) }),
  },
})
function Bs () {
  return zg()
...
var Ec = (e) => N('analytics/staticFilter/select', D.Search, (t) => t.logStaticFilterSelect(e))()
var go = (e) => N('analytics/staticFilter/deselect', D.Search, (t) => t.logStaticFilterDeselect(e))()
var wc = (e) => N('analytics/staticFilter/clearAll', D.Search, (t) => t.logStaticFilterClearAll(e))()
var ky = O(fa(), (e) =>
  e
    .addCase(mo, (t, r) => {
      const a = r.payload
...
function eS () {
  return { organizationId: 'searchuisamples', accessToken: 'xx564559b1-0045-48e1-953c-3addd1ee4457' }
}
var tS = new K({
  ...Zy,
  search: new Q({
...
function rS () {
  return { ...eS(), search: { searchHub: 'default' } }
}
var ip = (e) => S(e, { evt: q, type: ue })
var aS = (e) =>
  N('analytics/generic/search', D.Search, (t) => {
    ip(e)
    const { evt: r, meta: a } = e
    return t.logSearchEvent(r, a)
  })()
var nS = (e) =>
  N(
    'analytics/generic/click',
    D.Click,
    (t, r) => (Ue(e.result), ip(e), t.logClickEvent(e.evt, Be(e.result, r), We(e.result), e.meta))
  )()
var oS = (e) =>
  N('analytics/generic/custom', D.Custom, (t) => (ip(e), t.logCustomEventWithType(e.evt, e.type, e.meta)))()
var Xc = N('analytics/interface/load', D.Search, (e) => e.logInterfaceLoad())
var uK = ys('analytics/interface/load', D.Search, (e) => e.logInterfaceLoad())
...
var lK = ys('analytics/interface/change', D.Search, (e, t) =>
  e.logInterfaceChange({ interfaceChangeTo: t.configuration.analytics.originLevel2 })
)
...
function xS (e) {
  ...
  return {
    ...
    add (n, o) {
      r(Rn({ contextKey: n, contextValue: o }))
    },
    remove (n) {
      r(vn(n))
    },
...
function CP (e) {
  return e.addReducers({ context: $c }), !0
}
function xP (e) {
  return xS(e)
}
...
function vP (e) {
  return e.addReducers({ dictionaryFieldContext: Hc }), !0
}
function RS (e) {
  if (!bP(e)) throw V
  const t = B(e)
...
var QI = new K({ id: fo, values: Ic })
function LI (e, t) {
  if (!jI(e)) throw V
  pe(e, QI, t.options, 'buildStaticFilter')
  const r = B(e)
  const { dispatch: a } = e
  const n = () => e.state
  const { id: o } = t.options
  return (
    a(mo(t.options)),
    {
      ...r,
      toggleSelect (i) {
        const s = JS(o, i)
        a(Cr({ id: o, value: i })), a(k(s))
      },
      toggleSingleSelect (i) {
        const s = JS(o, i)
        i.state === 'idle' && a(ka(o)), a(Cr({ id: o, value: i })), a(k(s))
      },
      deselectAll () {
        const i = wc({ staticFilterId: o })
        a(ka(o)), a(k(i))
      },
      isValueSelected (i) {
      ...
      get state () {
        var u
        const i = ((u = n().staticFilterSet[o]) == null ? void 0 : u.values) || []
        const s = i.some((c) => c.state !== 'idle')
...
function jI (e) {
  return e.addReducers({ staticFilterSet: jc }), !0
}
function JS (e, t) {
  const { caption: r, expression: a, state: n } = t
  return (n === 'idle' ? Ec : go)({ staticFilterId: e, staticFilterValue: { caption: r, expression: a } })
}
var BI = new K({ expression: oe, id: q })
var UI = new K({ isActive: new G() })
function XS (e, t) {
  if (($I(t.options.id), !_I(e))) throw V
  const r = B(e)
  const { dispatch: a } = e
  pe(e, BI, t.options, 'buildTab')
  const n = Oe(e, UI, t.initialState, 'buildTab')
  const { id: o, expression: i } = t.options
  return (
    a(Xs({ id: o, expression: i })),
    n.isActive && a(Aa(o)),
    {
      ...r,
      select () {
      ...
      get state () {
        var u
        return { isActive: (u = e.state.tabSet[o]) == null ? void 0 : u.isActive }
      },
    }
  )
}
function _I (e) {
  return e.addReducers({ configuration: W, tabSet: _y }), !0
}
function $I (e) {
  const t = De().analytics.originLevel2
  if (e === t) {
    throw new Error(
...
var pC = (e) => QE(e)()
var QE = (e) =>
  N('analytics/resultPreview/open', D.Click, (t, r) => {
    Ue(e)
    const a = Be(e, r)
    const n = We(e)
    return t.logDocumentQuickview(a, n)
  })
function Ap (e, t, r) {
  if (!LE(e)) throw V
  const { dispatch: a } = e
  const n = () => e.state
  const o = B(e)
  const { result: i, maximumPreviewSize: s } = t.options
  const u = i.uniqueId
  return {
    ...o,
    fetchResultContent () {
      a(Ai({ uniqueId: u, requestedOutputSize: s })), r && r()
    },
    get state () {
      const c = i.hasHtmlVersion
      const l = n().resultPreview
      const d = u === l.uniqueId ? l.content : ''
      const m = l.isLoading
      return { content: d, resultHasPreview: c, isLoading: m }
    },
  }
}
function LE (e) {
  return e.addReducers({ configuration: W, resultPreview: Hy }), !0
}
function jE (e, t) {
  return Ap(e, t, () => {
    e.dispatch(pC(t.options.result))
  })
}
var BE = new K(Hd)
function UE (e, t = {}) {
...
function $E (e) {
  ...
  const { dispatch: r } = e
  const a = () => e.state
  let n = a().triggers.redirectTo
  return {
    ...t,
    subscribe (o) {
      const i = () => {
        const s = n !== this.state.redirectTo
        ;(n = this.state.redirectTo), s && this.state.redirectTo && (o(), r(ws()))
      }
...
function YE (e) {
  ...
  const { dispatch: r } = e
  const a = () => e.state
  let n = a().triggers.executions
  return {
    ...t,
    subscribe (o) {
      const i = () => {
        const s = !Ta(this.state.executions, n, (u, c) => u.functionName === c.functionName && Ta(u.params, c.params))
        ;(n = this.state.executions), s && this.state.executions.length && (o(), r(Os()))
      }
      return i(), e.subscribe(i)
    },
    get state () {
      return {
        functionName: a().triggers.execute.functionName,
        params: a().triggers.execute.params,
        executions: a().triggers.executions,
      }
    },
  }
}
...
var dw = (e) =>
  N('analytics/recentResults/click', D.Custom, (t, r) => {
    Ue(e), t.logRecentResultClick(Be(e, r), We(e))
  })
var hC = (e) => dw(e)()
var yC = N('analytics/recentResults/clear', D.Custom, (e) => e.logClearRecentResults())
var pw = { initialState: { results: [] }, options: { maxLength: 10 } }
var fw = new K({ results: new Y({ required: !0 }) })
var mw = new K({ maxLength: new j({ required: !0, min: 1 }) })
function gw (e, t) {
  pe(e, mw, t == null ? void 0 : t.options, 'buildRecentResultsList'),
  Oe(e, fw, t == null ? void 0 : t.initialState, 'buildRecentResultsList')
}
function hw (e, t) {
  if (!yw(e)) throw V
  const r = B(e)
  ...
  const o = { ...pw, ...t }
  gw(e, o)
  const i = { results: o.initialState.results, maxLength: o.options.maxLength }
  return (
    a(Zn(i)),
    {
      ...r,
...
function yw (e) {
  return e.addReducers({ recentResults: Yc }), !0
}
function Sw (e, t) {
  return It(e, t, () => e.dispatch(hC(t.options.result)))
}
function Cw (e, t) {
  if (!xw(e)) throw V
  const r = {}
...
function Rw (e, t) {
  const r = dp(e, t)
  const { facetSearch: a, subscribe: n } = r
  return {
    subscribe: n,
    ...a,
    updateText: function (o) {
      a.updateText(o), a.search()
    },
    get state () {
      return r.state.facetSearch
    },
  }
}
function vw (e, t) {
...
function _ne (e) {
  return (
    e.addReducers({ advancedSearchQueries: Uy }), { updateAdvancedSearchQueries: Ks, registerAdvancedSearchQueries: Gs }
  )
}
function Zne (e) {
  return (
    e.addReducers({ categoryFacetSet: aa }),
    {
      deselectAllCategoryFacetValues: $t,
      registerCategoryFacet: Ur,
      toggleSelectCategoryFacetValue: _r,
      updateCategoryFacetNumberOfValues: Pa,
      updateCategoryFacetSortCriterion: Fn,
      updateFacetAutoSelection: jt,
    }
  )
}
function doe (e) {
  return (
    e.addReducers({ facetSet: ra }),
    {
      deselectAllFacetValues: Re,
      registerFacet: $r,
      toggleSelectFacetValue: Kt,
      updateFacetIsFieldExpanded: Ea,
      updateFacetNumberOfValues: Ia,
      updateFacetSortCriterion: In,
      updateFreezeCurrentValues: Hr,
      updateFacetAutoSelection: jt,
    }
  )
}
function xoe (e) {
  return (
    e.addReducers({ configuration: W }),
    {
      ...
      setOriginLevel2: Ws,
      setOriginLevel3: Ys,
      updateAnalyticsConfiguration: Lr,
      updateBasicConfiguration: Qr,
    }
  )
}
function Aoe (e) {
...
function Ooe (e) {
  return e.addReducers({ context: $c }), { addContext: Rn, removeContext: vn, setContext: xn }
}
function Voe (e) {
  return e.addReducers({ dictionaryFieldContext: Hc }), { addContext: lo, removeContext: po, setContext: uo }
}
function Loe (e) {
  return e.addReducers({ debug: Co }), { disableDebug: bn, enableDebug: Br }
}
function Woe (e) {
  return (
...
function eie (e) {
  return e.addReducers({ facetOptions: Te }), { updateFacetOptions: ie, enableFacet: Le, disableFacet: Se }
}
function nie (e) {
  return (
    e.addReducers({ didYouMean: zc, query: mt }),
    { applyDidYouMeanCorrection: Bt, disableDidYouMean: bs, enableDidYouMean: dn }
  )
}
function cie (e) {
  return (
    e.addReducers({ fields: na }),
    { registerFieldsToInclude: Yr, enableFetchAllFields: Ln, disableFetchAllFields: qa, fetchFieldsDescription: jn }
  )
}
function pie (e) {
  return e.addReducers({ history: Gc, facetOrder: Qc }), { back: fi, forward: As }
}
function xie (e) {
  return (
...
function Iie (e) {
  return e.addReducers({ folding: Mc }), { registerFolding: Kr, loadCollection: Gr }
}
function qie (e) {
  return (
    e.addReducers({ pagination: nr }),
    {
      nextPage: an,
      previousPage: nn,
      registerNumberOfResults: en,
      registerPage: rn,
      updateNumberOfResults: tn,
      updatePage: Lt,
    }
  )
}
function Vie (e) {
  return e.addReducers({ pipeline: yo }), { setPipeline: Bn }
}
function jie (e) {
...
function tse (e) {
  return (
    e.addReducers({ instantResults: Uc }),
    { registerInstantResults: un, updateInstantResultsQuery: Vr, clearExpiredResults: ln }
  )
}
function dse (e) {
  return (
...
function yse (e) {
  return (
    ...
    e.addReducers({ redirection: $y }),
    { checkForRedirection: Pc }
  )
}
function bse (e) {
  return (
    e.addReducers({ search: Z }),
    { executeSearch: k, fetchMoreResults: Ut, fetchFacetValues: Ye, fetchPage: ut, fetchInstantResults: Mr }
  )
}
function Ise (e) {
  return e.addReducers({ searchHub: So }), { setSearchHub: ta }
}
function qse (e) {
  return e.addReducers({ sortCriteria: _c }), { registerSortCriterion: so, updateSortCriterion: co }
}
function Bse (e) {
  return (
    e.addReducers({ standaloneSearchBoxSet: Wc }),
    {
      registerStandaloneSearchBox: ao,
      fetchRedirectUrl: ea,
      updateAnalyticsToSearchFromLink: oo,
      updateAnalyticsToOmniboxFromLink: io,
      resetStandaloneSearchBox: no,
    }
  )
}
function Wse (e) {
  return (
    e.addReducers({ staticFilterSet: jc }),
    { registerStaticFilter: mo, toggleSelectStaticFilterValue: Cr, deselectAllStaticFilterValues: ka }
  )
}
function Jse (e) {
  return (
    e.addReducers({ questionAnswering: ir }),
    {
      collapseSmartSnippet: Wn,
      expandSmartSnippet: zn,
      dislikeSmartSnippet: Kn,
      likeSmartSnippet: Yn,
      openFeedbackModal: Gn,
      closeFeedbackModal: Zr,
      expandSmartSnippetRelatedQuestion: Jn,
      collapseSmartSnippetRelatedQuestion: Xn,
    }
  )
}
function tce (e) {
  return e.addReducers({}), { deselectAllFacets: ct, deselectAllBreadcrumbs: qe, deselectAllNonBreadcrumbs: cn }
}
function ice (e) {
  return e.addReducers({ recentQueries: Kc }), { registerRecentQueries: to, clearRecentQueries: ro }
}
function dce (e) {
  return (
    e.addReducers({ recentResults: Yc }), { registerRecentResults: Zn, clearRecentResults: eo, pushRecentResult: ar }
  )
}
function gce (e) {
  return e.addReducers({ excerptLength: Wy }), { setExcerptLength: kc }
}
...
function kue (e) {
  return (
    e.addReducers({}),
    {
      logClearBreadcrumbs: Fu,
      logInterfaceLoad: Xc,
      logSearchFromLink: Zc,
      logOmniboxFromLink: eu,
      logInterfaceChange: ia,
      logDidYouMeanClick: Fs,
      logCategoryFacetBreadcrumb: bu,
      logFacetBreadcrumb: hc,
      logFacetClearAll: je,
      logFacetDeselect: At,
      logFacetSelect: Ae,
      logFacetShowLess: Mn,
      logFacetShowMore: Nn,
      logFacetUpdateSort: tr,
      logDateFacetBreadcrumb: Pu,
      logNumericFacetBreadcrumb: Iu,
      logNavigateBackward: gu,
      logNavigateForward: mu,
      logPageNext: Su,
      logPageNumber: vo,
      logPagePrevious: Cu,
      logPagerResize: Ro,
      logSearchboxSubmit: Fo,
      logQuerySuggestionClick: vu,
      logResultsSort: Ao,
      logDislikeSmartSnippet: Mu,
      logLikeSmartSnippet: Nu,
      logOpenSmartSnippetFeedbackModal: ju,
      logCloseSmartSnippetFeedbackModal: Bu,
      logSmartSnippetFeedback: Uu,
      logSmartSnippetDetailedFeedback: _u,
      logExpandSmartSnippet: Du,
      logCollapseSmartSnippet: Vu,
      logExpandSmartSnippetSuggestion: $u,
      logCollapseSmartSnippetSuggestion: Hu,
      logNoResultsBack: hu,
      logStaticFilterSelect: Ec,
      logStaticFilterDeselect: go,
      logStaticFilterClearAll: wc,
      logTriggerQuery: Ps,
      logUndoTriggerQuery: Is,
      logNotifyTrigger: Es,
      logTriggerRedirect: ws,
...
function Mue (e) {
  return (
    ...
    {
      logDocumentOpen: xu,
      logOpenSmartSnippetSource: Qu,
      logOpenSmartSnippetSuggestionSource: zu,
      logOpenSmartSnippetInlineLink: Lu,
      logOpenSmartSnippetSuggestionInlineLink: Wu,
    }
  )
}
function _ue (e) {
  return e.addReducers({}), { logSearchEvent: aS, logClickEvent: nS, logCustomEvent: oS }
}
function Pw (e) {
...
function CC (e) {
  return {
    toQuerySyntax () {
      const { field: t, value: r } = e
      const a = ht(e.operator)
      return `${ke(e)}@${t}${a}${r}`
    },
  }
}
function xC (e) {
  return {
    toQuerySyntax () {
      const t = ke(e)
      const { field: r, from: a, to: n } = e
      const o = ht('isExactly')
      return `${t}@${r}${o}${a}..${n}`
    },
  }
}
...
function FC (e) {
  return {
    toQuerySyntax () {
      const t = ke(e)
      const { startTerm: r, otherTerms: a } = e
      const n = ww(a)
      const o = `${r} ${n}`
...
function ww (e) {
  return e
    .map((t) => {
      const { endTerm: r, maxKeywordsBetween: a } = t
      return `near:${a} ${r}`
    })
    .join(' ')
}
...
function Ow (e) {
  return Object.entries(e)
    .map((t) => {
      const [r, a] = t
      const n = typeof a === 'string' ? a : a.toQuerySyntax()
      return `${r}: ${n}`
    })
    .join(', ')
}
function EC (e) {
  return {
    toQuerySyntax () {
      const t = ke(e)
      const { field: r, operator: a, value: n } = e
      const o = ht(a)
      const i = a === 'fuzzyMatch' ? ` $quoteVar(value: ${n})` : `("${n}")`
      return `${t}@${r}${o}${i}`
    },
  }
}
function wC (e) {
  return {
    toQuerySyntax () {
      ...
      const r = ke(e)
      const a = ht(e.operator)
      const n = e.values.map((i) => `"${i}"`)
      const o = n.length === 1 ? n[0] : `(${n.join(',')})`
      return `${r}@${t}${a}${o}`
    },
  }
}
function cde () {
  ...
  return {
    ...
    addKeyword (r) {
      return e.push(bC(r)), this
    },
    addNear (r) {
      return e.push(FC(r)), this
    },
    addExactMatch (r) {
      return e.push(RC(r)), this
    },
    addFieldExists (r) {
    ...
    addNumericField (r) {
      return e.push(AC(r)), this
    },
    addNumericRangeField (r) {
      return e.push(PC(r)), this
    },
    addDateField (r) {
      return e.push(CC(r)), this
    },
    addDateRangeField (r) {
      return e.push(xC(r)), this
    },
    addQueryExtension (r) {
    ...
    toQuerySyntax () {
      const r = qw(t)
      const a = e.map((n) => n.toQuerySyntax()).join(`) ${r} (`)
...
const sampleComponentCss =
  'nav{width:300px;display:flex;justify-content:space-around}button{color:var(--atomic-on-primary);background-color:var(--atomic-primary)}'
...
const SampleComponent = class {
  ...
  async connectedCallback () {
    try {
      ...
      const statusController = ME(this.bindings.engine)
      this.pagerController = mI(this.bindings.engine)
