...
This is a new paragraph for a monospace `word`, and a monospace `phrase of text`. `*_monospace bold italic phrase_*` & ``**__char__**``acter``**__s__**`` https://docs.antora.org/antora/latest/asciidoc/monospace/[ref]
