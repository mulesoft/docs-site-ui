...
* The product does not run after installation unless you complete the xref:installing-anypoint-data-gateway.adoc#_post_installation_steps[post-installation steps].
