...
4. Change pagination, see https://docs.coveo.com/en/atomic/latest/reference/components/atomic-pager/
5. Updates at https://github.com/mulesoft/dev-docs-dmc-search require coveo cli - https://docs.coveo.com/en/cli/
