...
Next, make sure that you have at least Node 16 installed.

 $ node -v

If this command fails with an error, you don't have Node installed.
If the command doesn't report a Node 16 version or better (for example, v16.27.0), you don't have a suitable version of Node installed.
...
Once you've installed nvm, open a new terminal and install Node 16 using the following command:

 $ nvm install 16 --default

Verify again that you have Node 16 installed by running:
...
1. Figure out a way to run the preview and cypress tests in a single command
2. Tests work from Electron, but not from command-line; why?
3. Change pagination, see https://docs.coveo.com/en/atomic/latest/reference/components/atomic-pager/
4. Updates at https://github.com/mulesoft/dev-docs-dmc-search require coveo cli - https://docs.coveo.com/en/cli/
